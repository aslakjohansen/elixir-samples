defmodule Chirp.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", lines_count: 42, reposts_count: 42, username: "some username"}
    @update_attrs %{body: "some updated body", lines_count: 43, reposts_count: 43, username: "some updated username"}
    @invalid_attrs %{body: nil, lines_count: nil, reposts_count: nil, username: nil}
